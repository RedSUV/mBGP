...
Процедура ПриНачалеРаботыСистемы()
	...
	#Если МобильноеПриложениеКлиент или МобильныйКлиент Тогда 
		ГеопозиционированиеВызовСервера.АрхивацияТекущегоТрека();
...
Процедура ПриЗасыпанииКлиентскогоПриложения()
	...
	//ОбщегоНазначенияВызовСервера.ПриЗасыпанииКлиентскогоПриложения();
КонецПроцедуры
...
Процедура Подключаемый_ЗапуститьОбменИзменениями() Экспорт
	...
	ПодключитьОбработчикОжидания("Подключаемый_ЗапуститьОбменИзменениями", 300, ИСТИНА);
КонецПроцедуры
