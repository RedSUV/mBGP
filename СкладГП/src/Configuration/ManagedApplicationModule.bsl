...
Процедура ПриНачалеРаботыСистемы()
	...
	#Если МобильноеПриложениеКлиент или МобильныйКлиент Тогда 
		...
		ГеопозиционированиеКлиент.ПриСтартеСистемы();
...
// Процедура ПодключитьОбработчикиУведомлений предназначена для настройки обработки уведомлений 
...
Асинх Процедура ВыполнитьПоискОбновлений() Экспорт
	...
	Если Ответ = Неопределено Тогда
		Сообщить("Нет доступа к серверу обновлений..");	
		Возврат;
	...
	ИначеЕсли Ответ.КодСостояния = 200 Тогда
		...
		Иначе
			...
			Если ОтветНачСкач = КодВозвратаДиалога.Да Тогда
				ОбщегоНазначенияКлиент.ЗапускСкачиванияУстановкиОбновления(
					ОбщегоНазначенияВызовСервераПовтИсп.АдресОбновлений() + ИмяФайла);
