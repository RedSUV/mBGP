...
Процедура ОбновитьСлужебныеСправочники(Команда)
	...
	//Элементы.ДекорацияСостоянияОбновления.Заголовок = "Ячейки склада...";
	//ОбновитьЯчейкиСклада();
	//Элементы.ДекорацияСостоянияОбновления.Заголовок = "Сорта ПМ...";
	//ОбновитьСортаПМ();
	//Элементы.ДекорацияСостоянияОбновления.Заголовок = "Виды продукции...";
	//ОбновитьВидыПродукцииПМ();
	//Элементы.ДекорацияСостоянияОбновления.Заголовок = "Влажности...";
	//ОбновитьВлажностиПМ();
	//Элементы.ДекорацияСостоянияОбновления.Заголовок = "Типы распила...";
	//ОбновитьТипыРаспила();
