...
Процедура ПриИзмененииПараметровЭкрана()
	ОбщегоНазначенияКлиент.ЗаполнитьСвойстваФормыПриИзмененииПараметровЭкрана(ЭтотОбъект);
	
	Если Не ГоризонтальноеПоложениеЭкрана Тогда
		НоваяГруппировка = ГруппировкаПодчиненныхЭлементовФормы.Вертикальная;
	Иначе
		НоваяГруппировка = ГруппировкаПодчиненныхЭлементовФормы.ГоризонтальнаяВсегда;
	КонецЕсли;

	Элементы.ГруппаПленкаВерх.Группировка		 = НоваяГруппировка;
	Элементы.ГруппаПродукцияВерх.Группировка	 = НоваяГруппировка;
	Элементы.ГруппаПленкаБок.Группировка		 = НоваяГруппировка;
	Элементы.ГруппаПродукцияБок.Группировка		 = НоваяГруппировка;
	Элементы.ГруппаПленкаТорец.Группировка		 = НоваяГруппировка;
	Элементы.ГруппаПродукцияТорец.Группировка	 = НоваяГруппировка;
	Элементы.ГруппаПленкаУглы.Группировка		 = НоваяГруппировка;
	Элементы.ГруппаПродукцияУглы.Группировка	 = НоваяГруппировка;
...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	НаборЗаписей.Отбор.Пакет.Установить(Запись.Пакет);
	НаборЗаписей.Отбор.ИдентификаторЗаписи.Установить(Запись.ИдентификаторЗаписи);
	МобильноеПриложениеСкладПУ.ЗарегистрироватьВПланеОбмена(НаборЗаписей);
КонецПроцедуры
